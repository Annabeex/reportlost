...
- heroSubtitle : un constat factuel de la situation locale, du type "Lost property in <ville> is handled separately by <police locale>, <transports>, and the venues themselves.", avec les vrais noms locaux, suivi d'une seule phrase sobre sur ce que ReportLost prend en charge. Le sous-titre reste court : n'y fais PAS figurer la nuance sur les dépôts acceptés par un tiers, elle apparaît ailleurs dans la page.
