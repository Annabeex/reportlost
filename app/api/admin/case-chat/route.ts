...
Ton factuel et administratif. ⚠️ GÉNÉRIQUE et réutilisable tel quel pour PLUSIEURS organismes : salutation neutre "Dear Sir or Madam", ne jamais nommer l'organisme dans le sujet ni le corps, et toujours inclure "Could you kindly forward this message to the appropriate department or lost and found service?". L'email personnel du client peut y figurer si utile. Structure : signalement de l'objet perdu, description précise, lieu, date et créneau, demande de vérification des registres lost & found, référence #<public_id>, contact de réponse.
