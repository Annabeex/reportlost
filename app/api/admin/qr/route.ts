...
const PUBLIC_BASE_URL =
  process.env.NEXT_PUBLIC_SITE_URL || "https://reportlost.org";

export async function GET(req: NextRequest) {
  try {
    // ✅ “anti-rouge” robuste : on n’expose AUCUN type de 'qrcode' à TS
    //    (si les d.ts manquent, on s’en fiche : on cast en any)
    // @ts-ignore  — on ignore l’absence de d.ts éventuelle pour 'qrcode'
