...
export default function ReportContribution({ contribution, onChange, onSubmit, onBack }: Props) {
  return (
    <div className="bg-white shadow-md rounded-xl p-6 space-y-6 max-w-2xl mx-auto">
